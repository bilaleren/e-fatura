...
| [--pdf-options [options...]](https://github.com/bilaleren/e-fatura/blob/master/packages/e-fatura-cli/docs/PDF_OPTIONS.md) | PDF oluşturma seçenekleri                                                                                                                      | Hayır   | \-                       | \-                                                                                  |
...
<div id="e-fatura-xslt-renderer"></div>
...
docker run \
    ...
    bilaleren/e-fatura xslt-renderer [options] ./gib-e-archive.xslt
```
